        ...
        <div>
          ...
          <div className="mb-[3rem] flex items-center md:space-x-10">
            ...
            <p className="text-[19px] text-slate-300 w-[80%]">
              ...
              consequatur velit architecto accusantium molestiae vitae
              consectetur delectus, dolor maxime, saepe nulla id, quae quasi
              rerum reiciendis qui ab nostrum natus!
            </p>
          </div>
