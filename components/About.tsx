...
const About = () => {
  return (
    <div className='bg-[#121121] pb-[3rem] pt-[4rem] md:pt-[8rem]'>
        <div className='grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[5rem] items-center
        '>
            ...
            <div>
                <h1 className='text-[20px] font-bold uppercase gradient-text mb-[1rem]'>About Me</h1>
                ...
                <div className='mb-[3rem] flex items-center md:space-x-10'>
                    ...
                    <p className='text-[19px] text-slate-300 w-[80%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo consequatur velit architecto accusantium molestiae vitae consectetur delectus, dolor maxime, saepe nulla id, quae quasi rerum reiciendis qui ab nostrum natus!</p>
                </div>
