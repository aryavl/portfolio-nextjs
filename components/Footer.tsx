        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-b-[1px] pb-[6rem] border-gray-400 w-[80%] mx-auto gap-[3rem]'>
            <div className='flex items-center space-x-6'>
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>Athiralayam <br/>
                    Chekkakonam P O <br/>
                    Karakulam, Trivandrum <br/>
                    Kerala, India
                    </p>
                </div>
            </div>
            <div className='flex items-center space-x-6'>
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>+918075365474</p>
                </div>
            </div>
            <div className='flex items-center space-x-6'>
                <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[rgb(192,132,252)] '>
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>aryavl9813@gmail.com</p>
                </div>
            </div>
        </div>
        <div className='w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between'>
            <div className='text-[18px] mb-[2rem] md:mb-0 text-white opacity-20'>
                Arya V L 2024 | All Rights are Reserved
            </div>
