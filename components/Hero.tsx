...
const Hero = () => {
  return (
    <div className='sm:h-[100vh]  bg-[url("/images/banner.jpg")] bg-cover bg-center'>
      <Particle />
      <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
        <div>
        <h1 className="text-[35px] md:text-[50px] gradient-text font-bold">
  HI, I&apos;M <span className="">ARYA V L</span>
</h1>
        <TextEffect/> 
<p className="mt-[1.5rem] text-[16px] text-[#ffffff92]">Hey there! 👋 I&apos;m Arya V L, a Full Stack Developer on a mission to elevate digital experiences to new heights. With expertise in ReactJS, NextJS, and NodeJS, I thrive on translating imaginative concepts into tangible, user-centric solutions.</p>
<div className="mt-[2rem]  flex-col space-y-6 sm:space-y-0 sm:flex sm:flex-row items-center sm:space-x-6 ">
    <a href="Arya V L CV.pdf" target="_blank" rel="noopener noreferrer">
...
<button className="flex items-center space-x-2 bg-[rgb(192,132,252)] text-white  rounded-full px-2 hover:bg-white hover:text-[#141c27]  py-[0.5rem]">
    ...
    <p className="text-[18px] font-semibold">Watch The Video</p>
        ...
        <Image src='/imagesport/hero-image.png'
       alt="user"
       width={500}
       height={500}
